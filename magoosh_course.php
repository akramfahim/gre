<?php 
    ...
    if(!isset($_SESSION['user'])) {
        ...
        $level_sql = $pdo->prepare("SELECT * FROM magoosh_word_settings WHERE user_id=?");
				...
				<div class="tab-content" id="v-pills-tabContent">
					<div class="tab-pane fade show active" id="v-pills-one" role="tabpanel" aria-labelledby="v-pills-one-tab">
						...
						<?php
                                ...
                                $statement = $pdo->prepare("SELECT * FROM magoosh_level_one_word where id BETWEEN 1 AND 5");
                                $statement->execute();
					...
					<div class="tab-pane fade" id="v-pills-two" role="tabpanel" aria-labelledby="v-pills-two-tab">
						...
						<?php
                                ...
                                $statementTwo = $pdo->prepare("SELECT * FROM magoosh_level_two_word where id BETWEEN 1 AND 5");
					...
					<div class="tab-pane fade" id="v-pills-three" role="tabpanel" aria-labelledby="v-pills-three-tab">
						...
						<?php
                                ...
                                $level_three_statementTwo = $pdo->prepare("SELECT * FROM magoosh_level_three_word where id BETWEEN 1 AND 5");
					...
					<div class="tab-pane fade" id="v-pills-four" role="tabpanel" aria-labelledby="v-pills-four-tab">
						...
						<?php
                                ...
                                $statementTwo = $pdo->prepare("SELECT * FROM magoosh_level_four_word where id BETWEEN 1 AND 5");
                                $statementTwo->execute();
                                $resultTwo = $statementTwo->fetchAll(PDO::FETCH_ASSOC);
                                ?>
					...
					<div class="tab-pane fade" id="v-pills-five" role="tabpanel" aria-labelledby="v-pills-five-tab">
						...
						<?php
                                ...
                                $statementTwo = $pdo->prepare("SELECT * FROM magoosh_level_five_word where id BETWEEN 1 AND 5");
                                $statementTwo->execute();
                                $resultTwo = $statementTwo->fetchAll(PDO::FETCH_ASSOC);
                                ?>
