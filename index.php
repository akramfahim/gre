...
<div class="container jumbotron p-4 p-md-5 text-white rounded bg-myColor">
    <div class="row">
        ...
        <div class="col-md-8 px-0">
            ...
            <p class="lead my-3">Test takers preparing to take the GRE (Graduate Record Exam) must command a high-level
                vocabulary to achieve a high score. This course includes the definitions of 333 words often appearing on
                the GRE.</p>
