        ...
        <!-- Horizontal tab -->
            <nav>
              <div class="nav nav-tabs nav-justified" id="nav-tab" role="tablist">
                <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true">Barron question</a>

                <a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="false">Magoosh question</a>

                <a class="nav-item nav-link" id="nav-contact-tab" data-toggle="tab" href="#nav-contact" role="tab" aria-controls="nav-contact" aria-selected="false">Manhattan question</a>
              </div>
            </nav>
                  ...
                  <tbody>
                    <?php foreach ($barron_questions as $barron_question): ?>
                      <tr>
                        ...
                        <td><button class="btn btn-info"><?php echo  strtoupper($barron_question['level']); ?></button></td>
                        <td><a href="question_edit.php?id=<?php echo $barron_question['id'] ?>" class="btn btn-primary">UPDATE</a></td>
                      </tr>
                    <?php endforeach ?>
                  </tbody>
                </table>
