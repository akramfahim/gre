                ...
                <nav>
                    <div class="nav nav-tabs nav-justified" id="nav-tab" role="tablist">
                        <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="#nav-home"
                            role="tab" aria-controls="nav-home" aria-selected="true">Barron Words</a>

                        <a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-profile"
                            role="tab" aria-controls="nav-profile" aria-selected="false">Magoosh Words</a>

                        <a class="nav-item nav-link" id="nav-contact-tab" data-toggle="tab" href="#nav-contact"
                            role="tab" aria-controls="nav-contact" aria-selected="false">Manhattan Words</a>
                    </div>
                </nav>
                        ...
                        <table class="table table-dark table-striped text-center">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><button
                                            class="btn btn-info"><?php echo  strtoupper($barron_word['level']); ?></button>
                                    </td>
                                    <td><a href="word_edit.php?id=<?php echo $barron_word['id'] ?>"
                        ...
                        <table class="table table-dark table-striped text-center">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><button
                                            class="btn btn-info"><?php echo  strtoupper($magoosh_word['level']); ?></button>
                                    </td>
                                    <td><a href="word_edit.php?id=<?php echo $magoosh_word['id'] ?>"
                                            class="btn btn-primary">UPDATE</a></td>
                                </tr>
                                <?php endforeach ?>
                            </tbody>
                        ...
                        <table class="table table-dark table-striped text-center">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><button
                                            class="btn btn-info"><?php echo  strtoupper($manhattan_word['level']); ?></button>
                                    </td>
                                    <td><a href="word_edit.php?id=<?php echo $manhattan_word['id'] ?>"
                                            class="btn btn-primary">UPDATE</a></td>
                                </tr>
                                <?php endforeach ?>
                            </tbody>
