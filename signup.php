      ...
      <div class="col-md-4 offset-md-4 signin-form">
        ...
        <form method="post" action="">
          <div class="form-group">
            ...
            <input type="text" name="username" required="required" class="form-control" id="username" aria-describedby="usernameHelp" placeholder="Enter Username">
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input type="password" name="re_password" required="required" class="form-control" id="re_password" placeholder="Confirm Password">
          </div>
